                ...
                .then(data => {
                    ...
                    if (data && data.CUSTOMER_INFORMATION) {
                        document.getElementById(targetId).innerHTML = `
                            ...
                            <p>Company name: ${data.CARD_INFORMATION.INSURER_CUSTOMER_NAME}</p>
                            <p>Card name: ${data.CARD_INFORMATION.CARD_NUMBER}</p>
                            <p> Have Casco or mandatory: ${data.CUSTOMER_INFORMATION.HAVE_CASCO_OR_MANDATORY} </p>
                        `;
                    } else {
