    ...
    @include('backend.partials.title_breadcrumbs',
        ['title' => 'Report Years',
         'breadcrumbs' => [
          ...
          'buttons' => [
              'create' => ['title' => 'Create Report Years', 'route' => route('backend.report_years.create')]
              ],
              ])
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($years as $year)
                                        <tr>
                                            ...
                                            <td>{{$year->year}}</td>
                                            <td>
                                                {{ $year->created_at->format('d/m/Y H:i:s') }}
                                            </td>
                                            <td >
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="{{route('backend.report_years.edit', $year)}}">Edit</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item txt-danger" data-record-action="delete"
                                                       data-record-delete-url="{{route('backend.report_years.destroy', $year)}}"
                                                       data-record-name="{{$year->title}}"
                                                       data-record-id="{{$year->id}}" data-bs-toggle="modal"
