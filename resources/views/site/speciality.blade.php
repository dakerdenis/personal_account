                ...
                <div class="search-content">
                    ...
                    <div class="search-results">
                        @foreach($doctors as $doctor)
                            <a href="{{ route('doctor', ['category' => $category, 'id' => $doctor->id]) }}" data-search="{{ $doctor->name }}" class="search-result doctor-search-result">
                                <img class="avatar" src="data:image/jpg;base64,{{ $doctor->image64 }}" width="140" height="140" alt="{{ $doctor->name }}" loading="lazy">
                                <span class="content">
                                    <span class="title">{{ $doctor->name }}</span>
                                    <span class="subtitle">{{ $doctor->workplace }}</span>
                                    <span class="rating">
                                        <img src="{{ asset('assets/images/pajamas_star.svg') }}" width="25" height="25" alt="" loading="lazy">
