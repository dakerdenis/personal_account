<section class="text-content gray-section all-news-section">
    <div class="main-container">
        <div class="header">
            ...
            <a class="primary-outline" href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL(app()->getLocale(), route('category', $blogCategory)) }}">
        ...
        <div class="news-grid">
            @foreach($articles as $article)
                <a href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL(app()->getLocale(), $article->link) }}" class="news-block animate-on-scroll animate__animated" data-animation="fadeIn">
                        <span class="image-container">
                            ...
                            @else
                                <img class="image lazy" width="480" height="480" src="{{ asset('assets/images/a-group-news-icon.webp') }}"
                                     data-src="{{ asset('assets/images/a-group-news-icon.webp') }}" alt="{{ $article->title }}" loading="lazy">
                            @endif
